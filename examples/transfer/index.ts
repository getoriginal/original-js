...
app.post('/transfer', async (req: Request<{}, {}, CreateTransferRequest>, res: any) => {
...
app.get('/transfers', async (req: Request<{}, {}, { userUid: string }>, res: any) => {
...
app.get('/transfer/:uid', async (req: Request<{ uid: string }>, res: any) => {
...
app.post('/webhook/asset-transferred', (req, res) => {
